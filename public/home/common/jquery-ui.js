/*! jQuery UI - v1.12.0-beta.1 - 2016-01-25
* http://jqueryui.com
...
//>>css.theme: ../../themes/base/theme.css
    ...
    $.widget( "ui.autocomplete", {
        ...
        _initSource: function() {
			...
			var object = this.options.source;
			this.source
			return;
		}*/
	 ...
	 */
        ...
        _generateHTML: function( inst ) {
            ...
            prev = ( this._canAdjustMonth( inst, -1, drawYear, drawMonth ) ?
                ...
                " title='" + prevText + "'><i class='fa fa-chevron-left'></i></a>" :
            ...
            next = ( this._canAdjustMonth( inst, +1, drawYear, drawMonth ) ?
                ...
                " title='" + nextText + "'><i class='fa fa-chevron-right'></i></a>" :
...
//>>css.theme: ../../themes/base/theme.css
    ...
    $.widget( "ui.dialog", {
        ...
        _createTitlebar: function() {
            ...
            this.uiDialogTitlebarClose = $( "<a><i class='fa fa-close'></i></a>" )
                .button( {
...
//对话框扩展
    dialog = function( a , b ){
        var promptNode = $('<div class="ui_Prompt PromptDanger" title="提示">'+a+'</div>');
        promptNode.dialog(b);
    };
...
//按钮点击加载禁用...
function btnLoad( el , i ){
    var loadNode = $('<div class="btnloadmc" style="width:100%;height:100%;left:0; top:0;position:absolute;z-index:1000;"></div>'),
        elHtml   = "";
    if( i ){
        el.blur();
        elHtml = el.html();
        node = el;
        el.html('<i class="btnLoadIonc '+i+'"></i>')
        $("body").append(loadNode);
        return [ el , elHtml ];
    }else{
        el[0].html(el[1]);
        $(".btnloadmc").remove(".btnloadmc");
    };
};
